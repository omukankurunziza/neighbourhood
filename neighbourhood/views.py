...
def index(request):
    title = 'Neighbourhood'
    image_posts = Neighbourhood.objects.all()
...
def search_results(request):
    if 'business' in request.GET and request.GET["business"]:
        ...
        searched_images = Business.search_by_name(search_term)
        message = f"{search_term}"

        return render(request, 'search_business.html',{"message":message,"images": searched_images})
